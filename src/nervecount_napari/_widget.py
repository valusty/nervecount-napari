...
@magic_factory(call_button='quantify_all', saving_path={'mode': 'd'})
def quantify_all(viewer:Viewer, image:Image, label:Labels, date_microscopy:str, op_date:str, animal:str,
                 paw:Literal['L','R'], group:Literal['co','s_tube', 'eptfe', 'autoneuropl', 'neurorr', 'scaffold']='co', spot:Literal['ps','tube','ds']='ps', 
    ...
    nfh_quantity_dict = measure.regionprops_table(label_data, intensity_image=image_data, properties=("label", "intensity_mean", "area", "axis_major_length", "axis_minor_length"))
